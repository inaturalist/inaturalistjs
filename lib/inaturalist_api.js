...
const iNaturalistAPI = class iNaturalistAPI {
  static requestAndReturn( fetch, options = { } ) {
    let responseHeaders;
    return fetch
      .then( response => {
      ...
      .then( text => iNaturalistAPI.thenWrap( text, responseHeaders, options ) );
  }
  ...
  static fetch( route, ids, p, options = { } ) {
    ...
    const headers = { ...iNaturalistAPI.defaultHeaders };
  ...
  static post( route, p, opts ) {
    ...
    const fetch = localFetch( url, fetchOpts );
    return iNaturalistAPI.requestAndReturn( fetch, options );
  }
  ...
  static thenWrap( response, backendResponseHeaders = {}, options = {} ) {
    let wrappedResponse;
    ...
    if ( options.responseHeaders ) {
      ...
      backendResponseHeaders.forEach( ( v, k ) => {
